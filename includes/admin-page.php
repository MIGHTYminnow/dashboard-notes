...
function display_admin_page() {
	...
	<div class="wrap">
		...
		<form id="dn-add">
			...
			<div>
				<label for="dn-add-content">Content</label>
				<textarea id="dn-add-content" name="content" rows="6" required></textarea>
			</div>

			<input type="hidden" name="action" value="dn-add">
...
add_action( 'init', function() {
	if ( isset( $_GET['debug'] ) ) {
		...
		$new_widget = [
			'title'  => 'Programmatically Added Widget',
			'content'   => '<p>This widget was added via code!</p>',
		];
